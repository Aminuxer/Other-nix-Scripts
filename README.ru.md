...
totp_p24.py + totp_p10.py - AI-портированный TOTP-генератор для Python 2.4+ и Python 1.0+
Работает в олдскульных 32-битных ОС типа win9x.
Для компьютерных музеев и олдскульных ИТ-археологов.
